<%-- 
    Document   : nosuccessform
    Created on : 08.11.2015, 11:05:05
    Author     : THaskioglu
--%>
            ...
            <div class="row">
                <div class="col-sm-3 col-md-2 sidebar">
                   <ul class="nav nav-sidebar">
                    ...
                    <br>
                <br>
                <h1>UPPs etwas ist schief gelaufen.</h1>
                Bitte überprufen Sie:
                <ul>
                    <li>Ob alle Eingabe Felder ausgefüllt wurden</li>
                    <li>Ob alle Eingabe Felder wurden richtig ausgefüllt worden sind</li>                  
                </ul>
                Wenn alles korrekt ist oder Sie sich unsicher sind kontaktieren sie ihren Administrator und 
                geben Sie ihm die Fehlermeldung<br>
                <b>Fehlermeldung:</b>
                <div style="
height: 100px;
overflow: scroll;
